 ...
 * ========================================================= */
var baseURL = $("#bootstrap-datepicker").data("context");
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr class="datepickter_table">'+
								'<th class="prev" style="background-color:none;border:none;"><img src="'+baseURL+'/common/bootstrap/image/arrow_left.png"></th>'+
								'<th colspan="5" class="switch" style="font-weight: bold;"></th>'+
								'<th class="next"><img src="'+baseURL+'/common/bootstrap/image/arrow_right.png"></th>'+
							'</tr>'+
						'</thead>',
		contTemplate: '<tbody><tr><td colspan="7" style="padding-left: 21px;"></td></tr></tbody>'
	};
